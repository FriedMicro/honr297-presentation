...
Gem::Specification.new do |s|
  ...
  s.extra_rdoc_files = ["README.rdoc".freeze, "BENCHMARKING.rdoc".freeze, "CONTRIBUTING.rdoc".freeze, "CHANGELOG.rdoc".freeze]
  s.files = ["BENCHMARKING.rdoc".freeze, "CHANGELOG.rdoc".freeze, "CONTRIBUTING.rdoc".freeze, "README.rdoc".freeze]
